    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item">
                    <a href="${pageContext.request.contextPath}/GenerateDoctorAppointmentReportServlet" class="menu-link">
                        <i class="fas fa-calendar-alt"></i> Appointments Report
                    </a>
                </li>
                <li class="menu-item">
                    <a href="${pageContext.request.contextPath}/GeneratePatientReportServlet" class="menu-link">
