    ...
    <style>
        ...
        * {
        ...
        .login-wrapper {
            ...
            padding: 2rem;
            position: relative;
            background: url('../images/patient-bg.jpg') no-repeat center center;
        ...
        <div class="login-container">
            ...
            <form action="${pageContext.request.contextPath}/UserLoginServlet" method="post">
                ...
                <div class="form-dropdown">
                    ...
                    <select id="user-type" name="role" class="dropdown-select" required>
                ...
                <div class="login-footer">
                    ...
                    <a href="${pageContext.request.contextPath}/view/ForgotPassword.jsp?type=User">Forgot Password?</a>
                </div>
            </form>
        </div>
    </div>
