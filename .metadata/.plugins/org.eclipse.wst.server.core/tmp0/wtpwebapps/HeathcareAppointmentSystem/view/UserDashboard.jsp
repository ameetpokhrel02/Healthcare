    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="patient-info">
                    <h3><%= session.getAttribute("fullName") != null ? session.getAttribute("fullName") : "Patient" %></h3>
                    <p><i class="fas fa-heartbeat"></i> Patient ID: <%= session.getAttribute("userId") != null ? session.getAttribute("userId") : "N/A" %></p>
                </div>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-title">Health Records</li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="${pageContext.request.contextPath}/view/ChangePassword.jsp" class="menu-link">
        ...
        <main class="main-content">
            ...
            <div class="stats-container">
                <div class="stat-card appointments">
                    ...
                    <div class="stat-change positive">
                        <i class="fas fa-arrow-up"></i> 1 new appointment
                    </div>
                </div>
                ...
                <div class="stat-card prescriptions">
                    ...
                    <div class="stat-change negative">
                        <i class="fas fa-arrow-down"></i> 2 expired
                    </div>
                </div>
                
                <div class="stat-card doctors">
                    <div class="stat-title">
                        <i class="fas fa-user-md"></i> My Doctors
                    </div>
                    <div class="stat-value">4</div>
                    <div class="stat-change positive">
                        <i class="fas fa-arrow-up"></i> 1 new doctor
                    </div>
                </div>
            </div>
                ...
                <table class="appointment-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="doctor-info">
                                    <img src="../images/doctor3.jpg" alt="Doctor" class="doctor-avatar">
                                    <span>Dr. Emily Davis</span>
                                </div>
                            </td>
                            <td>June 20, 11:15 AM</td>
                            <td>Consultation</td>
                            <td><span class="status-badge success">Confirmed</span></td>
                            <td>
                                <button class="action-btn view">
            ...
            <div class="quick-actions">
                <div class="action-card" onclick="window.location.href='${pageContext.request.contextPath}/view/BookAppointment.jsp'">
                    <div class="action-icon appointments">
                        <i class="fas fa-calendar-plus"></i>
                    </div>
                    <h3 class="action-title">Book Appointment</h3>
                    <p class="action-desc">Schedule a new appointment with a doctor</p>
                </div>
                
                <div class="action-card" onclick="window.location.href='${pageContext.request.contextPath}/view/MyPrescriptions.jsp'">
                    <div class="action-icon prescriptions">
                        <i class="fas fa-prescription-bottle-alt"></i>
                    </div>
                    <h3 class="action-title">View Prescriptions</h3>
                    <p class="action-desc">Check your current medications</p>
                </div>
                
                <div class="action-card" onclick="window.location.href='${pageContext.request.contextPath}/view/FindDoctors.jsp'">
                    <div class="action-icon doctors">
                        <i class="fas fa-user-md"></i>
                    </div>
                    <h3 class="action-title">Find Doctors</h3>
                    <p class="action-desc">Search for healthcare professionals</p>
                </div>
                
                <div class="action-card" onclick="window.location.href='${pageContext.request.contextPath}/view/UserProfile.jsp'">
